  ...
  <script type="text/javascript">
	$(document).ready(function(){
		...
		$('#findmovies').on('click',function(){
			...
			if ($.trim(searchby) != '' && $.trim(searchfor)) {
				
				$.post('movies.php',{action:action, searchby: searchby, searchfor: searchfor} ,
				function (data){
		...
		<div id="searchdiv" class="col-sm-4">
			...
			<form name='searchform' id="searchformovies" method = "post">		 
				...
				<div class="form-group row">
					...
					<label><input type="radio" name="searchby" value="Title">Title</label>
					<label><input type="radio" name="searchby" value="Genre">Genre</label>
					<label><input type="radio" name="searchby" value="Actor">Actor</label>
				</div>
